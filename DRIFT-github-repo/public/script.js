...
const productDetails = {
  ...
  "Satin Bonnet": {
    ...
    price: "$24.99",
    colors: ["Champagne", "Black", "Blush", "Rose"],
    images: { Champagne: "assets/product-gift-set.webp" },
  },
...
bagCheckout.addEventListener("click", async () => {
  ...
  try {
    ...
    bagCheckoutNote.textContent =
      "Shopify checkout is not connected yet. Add your Shopify products, variants, and private Storefront token to activate it.";
    console.error(error);
  } finally {
    bagCheckout.disabled = bag.length === 0;
