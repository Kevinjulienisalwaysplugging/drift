...
export const isReviewsWriteConfigured = Boolean(supabaseUrl && supabaseServiceKey);
...
export function createReviewsWriteClient() {
  if (!isReviewsWriteConfigured) {
    throw new Error("DRIFT review writes are not configured.");
  }
